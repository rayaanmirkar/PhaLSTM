...
df[df['Host genus'].isin(train_genera)].to_csv("new_train_split.csv", index=False)
df[df['Host genus'].isin(val_genera)].to_csv("new_val_split.csv", index=False)
df[df['Host genus'].isin(test_genera)].to_csv("new_test_split.csv", index=False)